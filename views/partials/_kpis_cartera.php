...
?>
<div class="kpis-grid">
    <a href="#sec-ventas-detalladas" class="kpi-card kpi-card--info kpi-clickable">
    ...
    <a href="#sec-pedidos-pendientes" class="kpi-card kpi-card--danger kpi-clickable">
        <div class="kpi-card__content">
    ...
    <a href="#sec-pedidos-pendientes" class="kpi-card kpi-card--secondary kpi-clickable">
        <div class="kpi-card__content">
